...
- Github will run an action to update the main github-pages landing page whenever a new index.html file is added to the docs folder.
    - I'll get the name of the project from the name used in CITATION.cff or, if that's empty, from the repo name.



## How to Give Feedback

See the [feedback doc here](FEEDBACK.md) for ways to input/comment
